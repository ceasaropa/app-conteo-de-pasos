...
class SensorManager {
  ...
  void startSensors() {
    _gyroSubscription = gyroscopeEventStream(
      ...
      // 🚀 NUEVO: Aplicar filtro Kalman al giroscopio
    ...
    _accSubscription = accelerometerEventStream(
      ...
      dataProcessor.addAccelerometer(
  ...
  void toggleSensors() {
    if (isRunning) {
      ...
      dataProcessor.matrizUltimosDatos = List.generate(
        5,
        (_) => List.filled(4, 0.0),
      );
      ...
      // 🚀 NUEVO: Reset de los filtros Kalman
